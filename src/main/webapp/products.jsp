...
<%@ include file="header.jsp" %>
	...
	<hr>
	<button id="new">새 상품등록</button><br><button id="delete">상품 삭제</button>
	<ul id="list">
	...
	// 동기 통신에서는 submi을 하면 사용자가 선택한 카테고리가 초기상태로 바뀝니다.
	// 선택 카테고리를 받아와서 설정하는 방법
	// 비동기 통신에서는 화면이 바뀌지 않으므로 아래 코드가 필요가없습니다
	//	const temp = '${cate}'
	</script>
	...
	<script type="text/javascript" src="assets/js/productApiSearch.js"></script>
